...
/// The `type` a ``RevenueWithdrawalState`` variant carries.
public enum RevenueWithdrawalStateKind: RawRepresentable, Codable, Hashable, Sendable {
    case pending
    case succeeded
    case failed
    ...
    public static let documentedCases: [RevenueWithdrawalStateKind] = [
        .pending,
        .succeeded,
        .failed,
    ]
