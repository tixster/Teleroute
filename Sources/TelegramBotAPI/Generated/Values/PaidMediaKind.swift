...
/// The `type` a ``PaidMedia`` variant carries.
public enum PaidMediaKind: RawRepresentable, Codable, Hashable, Sendable {
    case livePhoto
    case photo
    case preview
    case video
    ...
    public static let documentedCases: [PaidMediaKind] = [
        .livePhoto,
        .photo,
        .preview,
        .video,
