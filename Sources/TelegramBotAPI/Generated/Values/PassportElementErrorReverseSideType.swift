...
/// “identity_card”
public enum PassportElementErrorReverseSideType: RawRepresentable, Codable, Hashable, Sendable {
    case driverLicense
    case identityCard
    ...
    public static let documentedCases: [PassportElementErrorReverseSideType] = [
        .driverLicense,
        .identityCard,
    ]
}
