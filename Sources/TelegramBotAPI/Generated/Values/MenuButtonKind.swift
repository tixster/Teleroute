...
/// The `type` a ``MenuButton`` variant carries.
public enum MenuButtonKind: RawRepresentable, Codable, Hashable, Sendable {
    case commands
    case webApp
    case `default`
    ...
    public static let documentedCases: [MenuButtonKind] = [
        .commands,
        .webApp,
        .default,
    ]
